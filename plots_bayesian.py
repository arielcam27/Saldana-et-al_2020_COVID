...
Before runing this script, the script control_model_bayesian_inference.py 
must be run to generate the information in the folder named covid
...
### To generate the figure with the uncertainty region, 
### uncomment the following lines (it takes some time to generate the figure)
