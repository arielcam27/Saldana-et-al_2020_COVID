...
###############################################################################
Total_cases_qq = np.load('covid2/Tota_cases_distribution.npy')
...
pl.axvline(x = Predictive_values[-10],color='g',label='Prediction')
pl.axvline(x = data_new[-10],color='r',label='Real ')
pl.title('Predictive Cumulative cases for 31/03')
pl.legend(loc=0)
pl.savefig('covid2/pred10')
pl.show()
...
pl.axvline(x = Predictive_values[-9],color='g',label='Prediction')
pl.axvline(x = data_new[-9],color='r',label='Real ')
pl.title('Predictive Cumulative cases for 01/04')
pl.legend(loc=0)
pl.savefig('covid2/pred9')
pl.show()


pl.figure()
pl.hist(Total_cases_qq[:,-5],bins=30)
pl.axvline(x = Predictive_values[-5],color='g',label='Prediction')
pl.axvline(x = data_new[-5],color='r',label='Real ')
pl.title('Predictive Cumulative cases for 05/04')
pl.legend(loc=0)
pl.savefig('covid2/pred5')
pl.show()


pl.figure()
pl.hist(Total_cases_qq[:,-1],bins=30)
pl.axvline(x = Predictive_values[-1],color='g',label='Prediction')
pl.axvline(x = data_new[-1],color='r',label='Real ')
pl.title('Predictive Cumulative cases for 09/04')
pl.legend(loc=0)
pl.savefig('covid2/pred1')
pl.show()
...
pl.legend(loc=0)
pl.savefig('covid2/predictive_dates')
pl.show()
...
pl.ylabel('Total Infected', fontsize=14)
pl.legend(loc=0)
pl.savefig('covid2/predictive_dates_nodata')
pl.show()
